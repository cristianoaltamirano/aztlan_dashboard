...
<script src="<?php echo base_url(); ?>/assets/global/plugins/bootstrap-editable/inputs-ext/wysihtml5/wysihtml5.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>/assets/global/plugins/bootstrap-typeahead/bootstrap3-typeahead.min.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>/assets/pages/scripts/form-editable.min.js" type="text/javascript"></script>
...
<!--<script src="<?php /*echo base_url(); */?>lib/js/jquery-3.1.1.min.js" type="text/javascript"></script>
